...
void vector_set(vector_t *v, size_t loc, int value) {
    ...
    /* If the location is greater than or equal to the current size,
     * reallocate memory to accommodate the new location.
     */
    if (loc >= v->size) {
        /* Determine the new size needed to accommodate the new location */
        ...
        /* Update the vector's size and data pointers */
        v->size = new_size;
        v->data = new_data;
    }

    /* Set the value at the specified location to the provided value */
    v->data[loc] = value;
}
